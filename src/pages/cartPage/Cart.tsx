        ...
        {cart.length > 0 ? (
          ...
          <h2 className='h2'>cart</h2>
            ...
            <div className='cart-item'>
              {cart.map(({ cartId, image, name,description,price }) => (
                ...
                <div key={cartId} className='product4' >
                  ...
                  <div className='delete' onClick={() => handleDeleteCart(cartId)} ><BsFillTrashFill/></div>
                </div>
                </>
              ))}
            </div>
            <div className='payment'>
              ...
              <button>Checkout <MdOutlinePayment style={{position:"relative",top:"3px"}}/></button>
              </div>
              <div style={{display:"flex",justifyContent:"center",gap:"10px",fontSize:"40px"}}>
              <FaCcApplePay/>
              <FaCcPaypal/>
              <FaCcAmazonPay/>
              </div>
