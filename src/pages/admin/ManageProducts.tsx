...
const ManageProducts = () => {
  ...
  const handleEditItem = (_id: string) => {
    ...
    if (editedItem) {
      setEditProductForm({
        ...editedItem,
        _id: String(editedItem._id),
        categoryId: editedItem.categoryId.map((cat) => cat._id) as []
      })
    ...
    <div className="admin-content">
      ...
      <div className="form2">
        ...
        <div className="image-area">
          {imagePreview ? (
            <img src={imagePreview} alt={productForm.title} />
          ) : (
          ...
          <div key={product._id} className="table-row">
            {isEditing && product._id === editingProductId ? (
              ...
              <>
                ...
                <div className="table-actions">
                  <button onClick={() => handleEditItem(String(product._id))}>edit</button>
                </div>
              </>
            )}
          </div>
